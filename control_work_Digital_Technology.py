    ...
    if skipCheck == 0:    
        ...
        if listMessages[-1][0] != '203':
            ...
            if numberStation != 1 and listMessages[-1][0] == '205' and listMessages[-2][12] == '1' and compareField(13) == 0 and compareField(14) == 0:
                ...
                pass
                if flagLoging == 1:
                    fileTXTResult.write('\t Смена лок-ва не нужна и не выполнялась\n')    
                pass
            elif numberStation != 1 and listMessages[-1][0] == '205' and listMessages[-2][12] == '0' and (compareField(13) == 0 
                                                                                                          or compareField(14) == 0):
                numberErrors += 1
                fileTXTResult.write('\t Смена лок-ва НЕ НУЖНА, НО ВЫПОЛНЕНА. ОШИБКА ' + str(numberErrors) + '\n')
                pass
                if flagLoging == 1:
